...
namespace TrainingDiary
{
    public partial class MainPage : ContentPage
    {
        ...
        public void UpdateWelcomeLabelText(string text)
        {
            WelcomeLabel2.Text = text;
        }

        private void FontSizeValueChanged(object sender, ValueChangedEventArgs e)
        {
        ...
        private async void FontSizeSliderDragCompleted(object sender, EventArgs e)
        {
            await repository.SaveFontSizeAsync(fontSize);
        }

        private void WhenUserNull()
        {
